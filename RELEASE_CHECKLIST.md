...
- [x] Install the final cache-busted `0.1.0-beta.3` candidate into an isolated Codex home; run manifest, skill, and all 33 automated tests against that cache copy.
...
- [ ] Run the release validator against an anonymous tag checkout; run the plugin and skill validators plus all 33 automated tests against the anonymously installed cache copy.
